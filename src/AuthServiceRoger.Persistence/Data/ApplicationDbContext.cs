...
public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        //Tabla de User en Domain/Entities
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(e => e.Password).IsRequired().HasMaxLength(225);
            ...
            //Relaciones
            //Primero tiene la llave foranea
            entity.HasOne(e=> e.UserProfile).WithOne(p=> p.User).HasForeignKey<UserProfile>(p => p.UserId);
            //Cuando la relacion es de 1 a muchos no es necesario <Tabla> despues del HasForeignKey
